...
// adjust accordingly in the inspector
    ...
    public GameObject hp_pan;
// don't change these
    private Vector3 orbitSpeed = Vector3.zero;
    private float twistSpeed = 0;
...
// if fingers moving in opposite directions
                if (dot < -0.7f)
                {
                    ...
                    float pinchDelta = f0f1Dist - lastf0f1Dist; //9638111323
