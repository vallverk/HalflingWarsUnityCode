...
//		if (creature.tag == "Hound")
//		{
//			GameObject creatureAttackObj = Instantiate(gameManagerInfo.houndAttack_PF, new Vector3(cave.transform.position.x + 5, 0.1f, cave.transform.position.z), Quaternion.Euler(90, 0, 0)) as GameObject;
//			creatureAttackObj.transform.localScale = new Vector3(creatureAttackObj.transform.localScale.x * -1, creatureAttackObj.transform.localScale.y, creatureAttackObj.transform.localScale.z);
//			
//			// cave creature attack animation
//			Debug.Log("--> : " + cave.gameObject.name);
//			cave.transform.FindChild("GoblinChar01").gameObject.GetComponent<MeshRenderer>().enabled = false;
//			cave.transform.FindChild("GoblinChar02").gameObject.GetComponent<MeshRenderer>().enabled = false;
//			
//			if (cave.transform.FindChild("GoblinChar01").gameObject.transform.FindChild("attack_anim").gameObject.GetComponent<MeshRenderer>().enabled == false ||
//				cave.transform.FindChild("GoblinChar01").gameObject.transform.FindChild("Walk_anim").gameObject.GetComponent<MeshRenderer>().enabled == false)
//				cave.transform.FindChild("GoblinChar01").gameObject.transform.FindChild("LessAgg1_anim").gameObject.GetComponent<MeshRenderer>().enabled = true;
//			
//			if (cave.transform.FindChild("GoblinChar02").gameObject.transform.FindChild("attack_anim").gameObject.GetComponent<MeshRenderer>().enabled == false ||
//				cave.transform.FindChild("GoblinChar02").gameObject.transform.FindChild("Walk_anim").gameObject.GetComponent<MeshRenderer>().enabled == false)
//					cave.transform.FindChild("GoblinChar02").gameObject.transform.FindChild("LessAgg2_anim").gameObject.GetComponent<MeshRenderer>().enabled = true;
//		}
//		else if (creature.tag == "Barg")
//		{
//			GameObject creatureAttackObj = Instantiate(gameManagerInfo.bargAttack_PF, new Vector3(cave.transform.position.x + 5, 0.1f, cave.transform.position.z), Quaternion.Euler(90, 0, 0)) as GameObject;
//			creatureAttackObj.transform.localScale = new Vector3(creatureAttackObj.transform.localScale.x * 1, creatureAttackObj.transform.localScale.y, creatureAttackObj.transform.localScale.z);
//			
//			// cave creature attack animation
//			cave.transform.FindChild("GoblinChar01").gameObject.GetComponent<MeshRenderer>().enabled = false;
...
//		else if (creature.tag == "Cusith")
//		{
//			GameObject creatureAttackObj = Instantiate(gameManagerInfo.cusithAttack_PF, new Vector3(cave.transform.position.x + 5, 0.1f, cave.transform.position.z), Quaternion.Euler(90, 0, 0)) as GameObject;
//			creatureAttackObj.transform.localScale = new Vector3(creatureAttackObj.transform.localScale.x * 1, creatureAttackObj.transform.localScale.y, creatureAttackObj.transform.localScale.z);
//			
//			// cave creature attack animation
//			cave.transform.FindChild("GoblinChar01").gameObject.GetComponent<MeshRenderer>().enabled = false;
...
//		else if (creature.tag == "Sprout")
//		{
//			GameObject creatureAttackObj = Instantiate(gameManagerInfo.sproutAttack_PF, new Vector3(cave.transform.position.x + 5, 0.1f, cave.transform.position.z), Quaternion.Euler(90, 0, 0)) as GameObject;
//			creatureAttackObj.transform.localScale = new Vector3(creatureAttackObj.transform.localScale.x * 1, creatureAttackObj.transform.localScale.y, creatureAttackObj.transform.localScale.z);
//			
//			// cave creature attack animation
//			cave.transform.FindChild("GoblinChar01").gameObject.GetComponent<MeshRenderer>().enabled = false;
...
//		else if (creature.tag == "Nymph")
//		{
//			GameObject creatureAttackObj = Instantiate(gameManagerInfo.nymphAttack_PF, new Vector3(cave.transform.position.x + 5, 0.1f, cave.transform.position.z), Quaternion.Euler(90, 0, 0)) as GameObject;
//			creatureAttackObj.transform.localScale = new Vector3(creatureAttackObj.transform.localScale.x * 1, creatureAttackObj.transform.localScale.y, creatureAttackObj.transform.localScale.z);
//			
//			// cave creature attack animation
//			cave.transform.FindChild("GoblinChar01").gameObject.GetComponent<MeshRenderer>().enabled = false;
...
//		else if (creature.tag == "Dryad")
//		{
//			GameObject creatureAttackObj = Instantiate(gameManagerInfo.dryadAttack_PF, new Vector3(cave.transform.position.x + 5, 0.1f, cave.transform.position.z), Quaternion.Euler(90, 0, 0)) as GameObject;
//			creatureAttackObj.transform.localScale = new Vector3(creatureAttackObj.transform.localScale.x * 1, creatureAttackObj.transform.localScale.y, creatureAttackObj.transform.localScale.z);
//			
//			// cave creature attack animation
//			cave.transform.FindChild("GoblinChar01").gameObject.GetComponent<MeshRenderer>().enabled = false;
...
//		else if (creature.tag == "Nix")
//		{
//			GameObject creatureAttackObj = Instantiate(gameManagerInfo.nixAttack_PF, new Vector3(cave.transform.position.x + 5, 0.1f, cave.transform.position.z), Quaternion.Euler(90, 0, 0)) as GameObject;
//			creatureAttackObj.transform.localScale = new Vector3(creatureAttackObj.transform.localScale.x * 1, creatureAttackObj.transform.localScale.y, creatureAttackObj.transform.localScale.z);
//			
//			// cave creature attack animation
//			cave.transform.FindChild("GoblinChar01").gameObject.GetComponent<MeshRenderer>().enabled = false;
...
//		else if (creature.tag == "Draug")
//		{
//			GameObject creatureAttackObj = Instantiate(gameManagerInfo.draugAttack_PF, new Vector3(cave.transform.position.x + 5, 0.1f, cave.transform.position.z), Quaternion.Euler(90, 0, 0)) as GameObject;
//			creatureAttackObj.transform.localScale = new Vector3(creatureAttackObj.transform.localScale.x * 1, creatureAttackObj.transform.localScale.y, creatureAttackObj.transform.localScale.z);
//			
//			// cave creature attack animation
//			cave.transform.FindChild("GoblinChar01").gameObject.GetComponent<MeshRenderer>().enabled = false;
...
//		else if (creature.tag == "Dragon")
//		{
//			GameObject creatureAttackObj = Instantiate(gameManagerInfo.dragonAttack_PF, new Vector3(cave.transform.position.x + 5, 0.1f, cave.transform.position.z), Quaternion.Euler(90, 0, 0)) as GameObject;
//			creatureAttackObj.transform.localScale = new Vector3(creatureAttackObj.transform.localScale.x * 1, creatureAttackObj.transform.localScale.y, creatureAttackObj.transform.localScale.z);
//			
//			// cave creature attack animation
//			cave.transform.FindChild("GoblinChar01").gameObject.GetComponent<MeshRenderer>().enabled = false;
...
//		else if (creature.tag == "Leech")
//		{
//			GameObject creatureAttackObj = Instantiate(gameManagerInfo.leechAttack_PF, new Vector3(cave.transform.position.x + 5, 0.1f, cave.transform.position.z), Quaternion.Euler(90, 0, 0)) as GameObject;
//			creatureAttackObj.transform.localScale = new Vector3(creatureAttackObj.transform.localScale.x * 1, creatureAttackObj.transform.localScale.y, creatureAttackObj.transform.localScale.z);
//			
//			// cave creature attack animation
//			cave.transform.FindChild("GoblinChar01").gameObject.GetComponent<MeshRenderer>().enabled = false;
...
//		else if (creature.tag == "Leshy")
//		{
//			GameObject creatureAttackObj = Instantiate(gameManagerInfo.leshyAttack_PF, new Vector3(cave.transform.position.x + 5, 0.1f, cave.transform.position.z), Quaternion.Euler(90, 0, 0)) as GameObject;
//			creatureAttackObj.transform.localScale = new Vector3(creatureAttackObj.transform.localScale.x * 1, creatureAttackObj.transform.localScale.y, creatureAttackObj.transform.localScale.z);
//			
//			// cave creature attack animation
//			cave.transform.FindChild("GoblinChar01").gameObject.GetComponent<MeshRenderer>().enabled = false;
...
//		else if (creature.tag == "Lurker")
//		{
//			GameObject creatureAttackObj = Instantiate(gameManagerInfo.lurkerAttack_PF, new Vector3(cave.transform.position.x + 5, 0.1f, cave.transform.position.z), Quaternion.Euler(90, 0, 0)) as GameObject;
//			creatureAttackObj.transform.localScale = new Vector3(creatureAttackObj.transform.localScale.x * 1, creatureAttackObj.transform.localScale.y, creatureAttackObj.transform.localScale.z);
//			
//			// cave creature attack animation
//			cave.transform.FindChild("GoblinChar01").gameObject.GetComponent<MeshRenderer>().enabled = false;
...
//		else if (creature.tag == "DHound")
//		{
//			GameObject creatureAttackObj = Instantiate(gameManagerInfo.dHoundAttack_PF, new Vector3(cave.transform.position.x + 5, 0.1f, cave.transform.position.z), Quaternion.Euler(90, 0, 0)) as GameObject;
//			creatureAttackObj.transform.localScale = new Vector3(creatureAttackObj.transform.localScale.x * 1, creatureAttackObj.transform.localScale.y, creatureAttackObj.transform.localScale.z);
//			
//			// cave creature attack animation
//			cave.transform.FindChild("GoblinChar01").gameObject.GetComponent<MeshRenderer>().enabled = false;
...
//		else if (creature.tag == "Fenrir")
//		{
//			GameObject creatureAttackObj = Instantiate(gameManagerInfo.fenrirAttack_PF, new Vector3(cave.transform.position.x + 5, 0.1f, cave.transform.position.z), Quaternion.Euler(90, 0, 0)) as GameObject;
//			creatureAttackObj.transform.localScale = new Vector3(creatureAttackObj.transform.localScale.x * 1, creatureAttackObj.transform.localScale.y, creatureAttackObj.transform.localScale.z);
//			
//			// cave creature attack animation
//			cave.transform.FindChild("GoblinChar01").gameObject.GetComponent<MeshRenderer>().enabled = false;
...
//		else if (creature.tag == "HellHound")
//		{
//			GameObject creatureAttackObj = Instantiate(gameManagerInfo.hellHoundAttack_PF, new Vector3(cave.transform.position.x + 5, 0.1f, cave.transform.position.z), Quaternion.Euler(90, 0, 0)) as GameObject;
//			creatureAttackObj.transform.localScale = new Vector3(creatureAttackObj.transform.localScale.x * 1, creatureAttackObj.transform.localScale.y, creatureAttackObj.transform.localScale.z);
//			
//			// cave creature attack animation
//			cave.transform.FindChild("GoblinChar01").gameObject.GetComponent<MeshRenderer>().enabled = false;
...
//		else if (creature.tag == "Sprite")
//		{
//			GameObject creatureAttackObj = Instantiate(gameManagerInfo.spriteAttack_PF, new Vector3(cave.transform.position.x + 5, 0.1f, cave.transform.position.z), Quaternion.Euler(90, 0, 0)) as GameObject;
//			creatureAttackObj.transform.localScale = new Vector3(creatureAttackObj.transform.localScale.x * 1, creatureAttackObj.transform.localScale.y, creatureAttackObj.transform.localScale.z);
//			
//			// cave creature attack animation
//			cave.transform.FindChild("GoblinChar01").gameObject.GetComponent<MeshRenderer>().enabled = false;
...
//		else if (creature.tag == "Imp")
//		{
//			GameObject creatureAttackObj = Instantiate(gameManagerInfo.impAttack_PF, new Vector3(cave.transform.position.x + 5, 0.1f, cave.transform.position.z), Quaternion.Euler(90, 0, 0)) as GameObject;
//			creatureAttackObj.transform.localScale = new Vector3(creatureAttackObj.transform.localScale.x * 1, creatureAttackObj.transform.localScale.y, creatureAttackObj.transform.localScale.z);
//			
//			// cave creature attack animation
//			cave.transform.FindChild("GoblinChar01").gameObject.GetComponent<MeshRenderer>().enabled = false;
...
//		else if (creature.tag == "Djinn")
//		{
//			GameObject creatureAttackObj = Instantiate(gameManagerInfo.djinnAttack_PF, new Vector3(cave.transform.position.x + 5, 0.1f, cave.transform.position.z), Quaternion.Euler(90, 0, 0)) as GameObject;
//			creatureAttackObj.transform.localScale = new Vector3(creatureAttackObj.transform.localScale.x * 1, creatureAttackObj.transform.localScale.y, creatureAttackObj.transform.localScale.z);
//			
//			// cave creature attack animation
//			cave.transform.FindChild("GoblinChar01").gameObject.GetComponent<MeshRenderer>().enabled = false;
