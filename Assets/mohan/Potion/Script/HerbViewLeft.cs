...
public class HerbViewLeft : MonoBehaviour 
{
	public Herb[] herbs;
	...
	void Update () 
	{
		if(Screen.width == 1536 && Screen.height == 2048)
		{
			viewPosition = new Rect(1360,230,172,1060);
			scrollViewPos = new Rect(0,0,172,1060);
		}
		else
		{ 
			viewPosition = new Rect(680,115,86,530);
			scrollViewPos = new Rect(0,0,86,530);
		}
